module.exports = class Data1739988380733 {
    name = 'Data1739988380733'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "market_price" ("id" character varying NOT NULL, "market_id" text NOT NULL, "outcome_prices" text array NOT NULL, "txn_hash" text NOT NULL, CONSTRAINT "PK_2d0e67fad606926d3f44a79bab5" PRIMARY KEY ("id"))`)
    }
